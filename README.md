# Cryptography Knowledge Quiz System / 密码知识答题系统
...
- Web 端：用户注册、登录、资料管理、密码找回与重置
- 题库端：题目新增、编辑、删除、分类与难度管理、批量导入
- 答题端：普通答题、竞赛参与、竞赛提交、排行榜展示
- H5 活动端：输入昵称一键进入、15 题闯关、金银奖牌与获奖记录查询
- 管理后台：用户管理、题目管理、竞赛管理、昵称/头像审核
