...
const HEADER_ALIASES = {
  ...
  正确答案解析: 'correctExplanation',
  正确解析: 'correctExplanation',
  标准答案解析: 'correctExplanation',
  rightanalysis: 'correctExplanation',
  rightansweranalysis: 'correctExplanation',
  zhengquedaanjiexi: 'correctExplanation',
  wrongexplanation: 'wrongExplanation',
  错误答案解析: 'wrongExplanation',
  错误解析: 'wrongExplanation',
  erroranalysis: 'wrongExplanation',
  wrongansweranalysis: 'wrongExplanation',
  cuowujiexi: 'wrongExplanation',
  options: 'options',
  选项: 'options',
  xuanxiang: 'options',
  choices: 'options',
...
const transformRowToQuestion = (row) => {
  ...
  return normalizeQuestionPayload({
    ...
    correctExplanation: mappedRow.correctExplanation,
    wrongExplanation: mappedRow.wrongExplanation,
    options,
