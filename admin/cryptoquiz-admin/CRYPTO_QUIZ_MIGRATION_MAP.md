...
- `admin/cryptoquiz-admin/` 已接入 `crypto_quiz` 数据库，但此前只有 RuoYi 基础能力，没有竞赛业务模块。
...
- 领域模型：
  - `cryptoquiz-system/src/main/java/com/cryptoquiz/system/domain/QuizQuestion.java`
  - `cryptoquiz-system/src/main/java/com/cryptoquiz/system/domain/QuizCompetition.java`
  - `cryptoquiz-system/src/main/java/com/cryptoquiz/system/domain/QuizBusinessUser.java`
- 控制层：
  - `cryptoquiz-admin-module/src/main/java/com/cryptoquiz/web/controller/quiz/QuizQuestionController.java`
  - `cryptoquiz-admin-module/src/main/java/com/cryptoquiz/web/controller/quiz/QuizCompetitionController.java`
  - `cryptoquiz-admin-module/src/main/java/com/cryptoquiz/web/controller/quiz/QuizBusinessUserController.java`
- Service / Mapper：
  - `cryptoquiz-system/src/main/java/com/cryptoquiz/system/service/impl/QuizQuestionServiceImpl.java`
  - `cryptoquiz-system/src/main/java/com/cryptoquiz/system/service/impl/QuizCompetitionServiceImpl.java`
  - `cryptoquiz-system/src/main/java/com/cryptoquiz/system/service/impl/QuizBusinessUserServiceImpl.java`
  - `cryptoquiz-system/src/main/resources/mapper/quiz/*.xml`
...
5. `系统管理` 已收缩为 `权限管理`，当前仅保留管理员账号、权限角色、菜单权限三项核心能力。
