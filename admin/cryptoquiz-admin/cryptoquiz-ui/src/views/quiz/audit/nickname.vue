  ...
  <div class="app-container audit-page">
    ...
    <el-card shadow="never" class="audit-card filter-card">
      <div slot="header" class="section-header between-header">
        <div>
          <div class="section-title">筛选待审昵称</div>
          <div class="section-subtitle">按用户名、昵称或邮箱快速定位需要处理的申请</div>
        </div>
    ...
    <el-card shadow="never" class="audit-card table-card">
      <div slot="header" class="section-header">
        <div>
          <div class="section-title">昵称审核队列</div>
          <div class="section-subtitle">处理后会立即从当前列表移除，减少重复操作</div>
        </div>
      </div>
      <el-table v-loading="loading" :data="nicknameList" stripe class="audit-table">
