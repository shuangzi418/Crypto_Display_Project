...
const cryptoquizRoot = path.resolve(projectRoot, 'admin', 'cryptoquiz-admin');
const cryptoquizUiRoot = path.resolve(cryptoquizRoot, 'cryptoquiz-ui');
const cryptoquizAdminJar = path.resolve(cryptoquizRoot, 'cryptoquiz-admin', 'target', 'cryptoquiz-admin.jar');
